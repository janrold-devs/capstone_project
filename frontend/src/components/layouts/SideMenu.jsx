...
const SideMenu = ({ activeMenu }) => {
  ...
  return (
    <div className="w-64 h-full bg-primary border-r border-gray-200/50 p-5 flex flex-col">
        ...
        {SIDE_MENU_DATA.map((item, index) => {
          ...
          return (
            <button
              ...
              className={`w-full flex items-center gap-4 py-3 px-6 rounded-lg text-[15px] transition
                ${
