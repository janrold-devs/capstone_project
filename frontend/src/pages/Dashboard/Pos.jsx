                      ...
                      {sizes.map((size) => {
                        ...
                        return (
                          <button
                            ...
                            className="flex items-center gap-[6px] px-1 py-1 rounded-md hover:bg-gray-100 transition"
                          >
                            <SiBuymeacoffee
                            ...
                            <span className="ml-1 text-[11.5px] font-bold text-gray-600">
                              ₱{size.price}
                            </span>
                          </button>
                        );
          ...
          {currentScreen === "order" ? (
            <>
              ...
              <div className="flex justify-between items-center mb-4 md:mb-6">
                <h2 className="text-md font-semibold">Order #2156</h2>
                    ...
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="w-4 h-4 rounded-full border border-gray-300 flex items-center justify-center text-gray-500 hover:bg-gray-50"
                        >
                          −
                        </button>
